var td = $("#sample_1").children().find("tr:first td").length;
var header_data = $("#sample_1").children().find("tr:first th");
//alert(td);
var TableAdvanced = function () {
    ...
    var initTable1 = function() {
        ...
        function fnFormatDetails ( oTable, nTr  )
        {
            ...
            var sOut = '<table>';
            for(var i=1; i<=td; i++){
                sOut += '<tr><td>'+header_data.eq(i-1).text()+':</td><td>'+aData[i]+'</td></tr>';    
            }
