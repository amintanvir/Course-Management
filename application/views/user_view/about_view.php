<div class="b-inner-page-header f-inner-page-header b-bg-header-inner-page">
    ...
    <div class="l-main-container">
        ...
        <div class="b-breadcrumbs f-breadcrumbs">
            <div class="container">
                <ul>
                    <li><a href="<?php echo base_url();?>homepage/home/"><i class="fa fa-home"></i>Home</a></li>
                    <li><i class="fa fa-angle-right"></i><a href="<?php echo base_url();?>homepage/home/about_us">About us</a></li>
                </ul>
            </div>
        </div>
        ...
        <section class="b-infoblock--without-border b-diagonal-line-bg-light b-bg-full-primary">
            <div class="container">
                <h3 class="f-primary-b">Our skills</h3>
                <div class="row">
