...
<!-- BEGIN PAGE HEADER-->
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
						Employee Info <small>Save/Update/Remove</small>
					</h3>
					...
					<!-- BEGIN PORTLET-->
								...
								<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-reorder"></i><span id="localTitle">Add</span> Employee
										</div>
										<div class="tools">
                                                ...
                                                <div class="row">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
																<input type="text" class="form-control" name="txtSalary" id="txtSalary" placeholder="Enter Teachers Salary" />
          ...
          <div class="row">
				<div class="col-md-12">
					...
					<div class="portlet box half-black" id="dataTable">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>List of Employees
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
...
<script type="text/javascript">
				...
				$("#btnSave").click(function  (argument) {
					...
					if(updId != ""){
						urls = baseUrl+"admin/employee_info/update";
						message = "<font color='green'>Update Successfully</font>";
					}else if(deleteId!=""){
						urls = baseUrl+"admin/employee_info/delete";
						message = "<font color='green'>Successfully Deleted</font>";
					}else{
						urls = baseUrl+"admin/employee_info/save";
					...
					if(deleteId==""){
						...
						if(reqFullNameValidate==0||reqContactNumberValidate==0||expEmailValidate==0||reqDesignationValidate==0||reqJoinDateValidate==0||reqGenderValid==0){
							return false;
						}
					}
