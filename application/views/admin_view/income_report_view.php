			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
						Income Report <small>View/Report</small>
					</h3>
					...
					<!-- BEGIN PORTLET-->
								...
								<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-reorder"></i><span id="localTitle">Report of </span>Income
										</div>
										<div class="tools">
												...
												<div class="row">
													<div class="col-md-12">
														<div class="form-group">
															...
															<div class="col-md-3">
																<select id="ddlIncomeType" name="ddlIncomeType" class="form-control">
																	<option value="">SELECT INCOME TYPE</option>
																	<option value="student">Course Registration</option>
          ...
          <div class="row">
				<div class="col-md-12">
					...
					<div class="portlet box half-black" id="dataTable">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>Earning Report <span onclick="printDiv()">Print</span>
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse">
								</a>
...
<script type="text/javascript">
				...
				$("#btnViewReport").click(function  (argument) {
					...
					var incomeType = $("#ddlIncomeType option:selected").val();
					//alert(incomeType);
					var incomeTypeText = $("#ddlIncomeType option:selected").text();
					...
					if(specificDate!=""){
						...
						if(incomeType!=""){
							message+=" for "+incomeTypeText;
						}
					}

					var urls = "";
					if(specificDate!=""){
						urls=baseUrl+"admin/income_report/find_report_specific_date";
					}else{
						urls=baseUrl+"admin/income_report/find_report";
					}
					//alert(urls);
				    $.ajax({
				        url: urls,
